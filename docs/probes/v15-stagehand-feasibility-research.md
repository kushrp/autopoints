...
- **Living scrapers in 2026:** `tszumowski/aa_flight_search_tool` (Selenium, unmaintained), `luispic2021/aa_miles_monitor`, and Apify's [Flight Award & Itinerary Scraper](https://apify.com/igolaizola/flight-award-scraper) all still cite AA among their supported targets. Seats.aero ships AA inventory ([seats.aero/american](https://seats.aero/american)).
